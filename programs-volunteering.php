...
<div class="beside-toc">
    ...
    <ul>
        <li>Adult volunteer application (grade nine and above): click <a
                href="http://www.lincolnroadchapel.ca/pgm-download_media.php?name=Adult_volunteer_application_OCT_2011.pdf">here</a>
        </li>
        <li>Youth volunteer application (under grade eight): click <a
                href="http://www.lincolnroadchapel.ca/media/Volunteer_application_form_2.pdf">here</a>
        </li>
    </ul>
</div>
