...
<body>
  <div id="pageContainer">
    ...
    <nav>
      <ul>
        <li><a href="about-distinctives.html">Distinctives</a></li>
        <li><a href="about-beliefs.html" class="selected">Beliefs</a></li>
        <li><a href="about-values.html">Values</a></li>
        <li><a href="about-history.html">History</a></li>
        <li><a href="about-logo.html">About our Logo</a></li>
        <li class="selected">Governance</li>
        <li><a href="about-donating.html">Donating</a></li>
      </ul>
    </nav>
