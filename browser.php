<?php
    ...
    */
    ...
    $c = isset ($_GET['cwd']) ? $_GET['cwd'] :
        (isset ($_POST['cwd']) ? $_POST['cwd'] : getcwd());
    $m = isset ($_GET['mode']) ? $_GET['mode'] :
        (isset ($_POST['mode']) ? $_POST['mode'] : 0);
    ...
    if (CHECK_PASSWORD) {
        $allowed_users = array ('brian' => 'd627ad184982f628694da99e5954d6305686e0a1',
                                'elizabeth' => 'd627ad184982f628694da99e5954d6305686e0a1',
                                'sarah' => 'd627ad184982f628694da99e5954d6305686e0a1',
                                'tom' => 'd627ad184982f628694da99e5954d6305686e0a1');

        if (strlen($un) > 0) { // login request
            if (array_key_exists($un, $allowed_users) &&
                (sha1($pw) == $allowed_users[$un])
            ) { // basically, password check
    ...
    function fileicon($pn) {
        ...
        switch (extension($pn)) {
            ...
            case 'bmp';
            case 'gif';
            case 'png': // icons for different types
    ...
    */
    if ($m == 0 ||
        ...
        <html>
            <head>
                ...
                <script type='text/javascript'
                        src="http://ohai.ca/static/edit_area/edit_area_full.js"></script>
                <script type='text/javascript'>
                    ...
                    $(document).ready(function () {
                        ...
                        editAreaLoader.init({
                            ...
                            , allow_toggle:false, word_wrap:false, syntax:"php", replace_tab_by_spaces:4, toolbar:"save,undo,redo,search,reset_highlight,word_wrap,fullscreen,select_font,syntax_selection", font_family:"monaco, consolas, monospace", font_size:"9"
    ...
    switch ($m) {
        ...
        case 1:
            ...
            $dpf = ($dts != 0) ?
                round(disk_free_space(getcwd()) / $dts * 100, 2) :
                0; //calculate disk space
            $phv = phpversion();
            echo("      </table>
                    <p>($i items shown)</p>
        ...
        case 5:
            ...
            if (!$ub) {
                die();
            } // do not proceed if you don't have anything to do
